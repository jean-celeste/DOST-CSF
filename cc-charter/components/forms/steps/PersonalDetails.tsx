...
export default function PersonalDetails({ data, onChange }: PersonalDetailsProps) {
    ...
    return (
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-12" id="personal-details">
            <div className="space-y-6 sm:space-y-7 xl:col-span-8">
                ...
                <div className="space-y-2">
                    <label className="text-sm sm:text-base font-medium text-gray-800 flex items-center gap-2" htmlFor="contact">
                        ...
                        Contact Number <span className="text-xs sm:text-sm text-gray-400">(optional)</span>
                    </label>
                    <div className="relative">
                        <input
                            id="contact"
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="w-full h-10 appearance-none rounded-xl border border-gray-200 bg-white pl-10 pr-10 text-sm text-gray-700 transition-colors focus:border-blue-500 focus:outline-none"
                        >
                        ...
                        {data.age && <Check className="absolute right-8 top-1/2 h-4 w-4 -translate-y-1/2 text-green-500" />}
            ...
            <div className="hidden xl:flex xl:col-span-4 rounded-2xl bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 p-8 items-center justify-center">
                <div className="text-center space-y-4">
                    <Image src="/DOST_Logo.png" alt="DOST Logo" width={96} height={96} className="mx-auto h-24 w-24 object-contain" />
                    <h3 className="text-3xl font-bold text-gray-900 leading-tight">Department of Science and Technology V</h3>
                    <p className="text-lg text-gray-600">Client Feedback Form</p>
                </div>
            </div>
        </div>
    );
